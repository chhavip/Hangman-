...
@SuppressLint("NewApi") public class WorldGameActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		words = res.getStringArray(R.array.words_world);
		hints = res.getStringArray(R.array.world_hints);
		rand = new Random();
		currword = "";
			...
			if(numcorrect == numchars){
				...
				build.setPositiveButton("Play Again", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int id) {
						// TODO Auto-generated method stub
						WorldGameActivity.this.playGame();
					}
				});
