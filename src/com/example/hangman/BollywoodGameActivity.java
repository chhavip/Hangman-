...
@SuppressLint("NewApi") public class BollywoodGameActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		words = res.getStringArray(R.array.words_bollywood);
		hints = res.getStringArray(R.array.bollywood_hints);
		rand = new Random();
		currword = "";
			...
			if(numcorrect == numchars){
				...
				build.setPositiveButton("Play Again", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int id) {
						// TODO Auto-generated method stub
						BollywoodGameActivity.this.playGame();
					}
				});
				...
				build.setNegativeButton("Exit", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface arg0, int arg1) {
						// TODO Auto-generated method stub
						BollywoodGameActivity.this.finish();
					}
							});
