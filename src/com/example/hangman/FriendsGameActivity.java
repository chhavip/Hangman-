...
@SuppressLint("NewApi") public class FriendsGameActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		words = res.getStringArray(R.array.words_friends);
		hints = res.getStringArray(R.array.friends_hints);
		rand = new Random();
		currword = "";
			...
			if(numcorrect == numchars){
				...
				build.setPositiveButton("Play Again", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int id) {
						// TODO Auto-generated method stub
						FriendsGameActivity.this.playGame();
					}
				});
				...
				build.setNegativeButton("Exit", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface arg0, int arg1) {
						// TODO Auto-generated method stub
						FriendsGameActivity.this.finish();
					}
							});
